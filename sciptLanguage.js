...
const translations = {
  en: {
    ...
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・Learned <b>Japanese(N1). Native in English, Chinese(Simplified/Traditional), Malay, Hakka, Cantonese, some Hokkien.</b>"
    +"<br>"
  ...
  zh: {
    ...
    +"<b><h4>技能:</h4></b><br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・专精于<b>Unity</b>, 可熟悉运用 2D以及3D C# Coding, 包括但不限于 <b>Shader Programming, Profiling, Debugging, Optimization, Networking</b>进行游戏开发。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・有使用<b>虚幻引擎(Unreal Engine)</b> 的经验, 可使用<b>Blueprint</b> & <b>C/C++</b>进行游戏开发。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・有制作 <b>个人网站</b>的经验。熟悉使用以下语言： <b>JavaScript, HTML, CSS, php, MySQL...</b><br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・熟悉写<b>开发日志</b>。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・不擅长与人进行口头表达上的<b>沟通</b>，但文字表达上相对流畅。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・获得<b>日语(N1)准证. 母语为英文，中文（简体/繁体），马来文，客家语，粤语，一部分福建话（闽南语）</b>"
    +"<br>"

    +"<b><h4>思想:</h4></b><br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・享受 <b>开发游戏的过程</b>， 因为它总能给我提供一种成就感。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・个人口头禅： &nbsp;&nbsp;<b><i>如果一样事情可以被描述，那么它就可以被程序编写。</i></b><br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・抱有 <b>对新事物的好奇心</b>，因其总能让我认识新的世界。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・抱有 <b>对事物追根究底的精神</b>，因其总能让我理解事物运转的逻辑。<br>"
    +"&nbsp;&nbsp;&nbsp;&nbsp;"
    +"・在<b>压力下也能有良好表现</b>，也绝<b>不会延迟事物的完成日期</b>。<br>"
    ,
    projects_title: "项目",
    project1_title: "AXERAS",

...
const translations = {
  en: {
    ...
    "<br><h3>On-Going</h3><br>Improving my skills on Unity HLSL, Render Feature, ECS, and UE C/C++",
        HomePage:"HomePage"
  },
  ...
  zh: {
    ...
    "<br><h3>进行中</h3><br>目前正在提升 Unity HLSL、Renderer Feature, ECS 以及 UE C/C++ 的技能",
    HomePage:"主页"
  },
...
card03: "UTARを卒業",
    ...
    "<br><h3>進行中</h3><br>Unity HLSL、Renderer Feature、 ECS 、および UE C/C++ のスキル向上に取り組んでいます",
    HomePage:"ホームページ"
  },
};

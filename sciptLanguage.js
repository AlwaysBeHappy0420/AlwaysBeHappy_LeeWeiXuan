...
const translations = {
  en: {
    ...
    about_desc3:
      ...
      "・I love <b>Unreal</b> as well, not that much compared to Unity, but have experiences with <b>Blueprint</b> & <b>C/C++</b>.<br><br>" +
    ...
    about_desc4:
      ...
      '・I would <b>like to know "why" behind every question</b> and task which leads me to have high understanding of the item.<br><br>' +
      "・I can <b>work well under pressure</b>, and I'm <b>concious of time.</b><br><br>",
  ...
  zh: {
    ...
    about_desc3:
      ...
      "・有使用<b>虚幻引擎(Unreal Engine)</b> 的经验, 可使用<b>Blueprint</b> & <b>C/C++</b>进行游戏开发。<br><br>" +
    ...
    about_desc4:
      ...
      "・抱有 <b>对事物追根究底的精神</b>，因其总能让我理解事物运转的逻辑。<br><br>" +
      "・在<b>压力下也能有良好表现</b>，也绝<b>不会延迟事物的完成日期</b>。<br><br>",
    projects_title: "项目",
    project1_title: "AXERAS",
  ...
  jp: {
    ...
    about_desc3:
      ...
      "・<b>Unreal Engine</b> の使用経験があり、<b>Blueprint</b> および <b>C/C++</b> を用いたゲーム開発が可能です。<br><br>" +
    ...
    about_desc4:
      ...
      "・<b>常に新しい物事に好奇心を持ち</b>、それを通して新しい世界や価値観を学び続けています。<br><br>" +
      "・<b>物事を徹底的に追究する姿勢を強みとしており</b>、常に「なぜそう動くのか」という論理を理解することを大切にしています。。<br><br>" +
      "・<b>プレッシャーのかかる状況でも安定したパフォーマンスを発揮でき、期限を守ることを徹底しています。</b>。<br><br>",
